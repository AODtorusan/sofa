...
#
# Simon Billemont; Modified to handle empty CMAKE_SYSTEM_PROCESSOR
...
if (DEFINED ${CMAKE_SYSTEM_PROCESSOR})
	...
	if(    ${CMAKE_SYSTEM_PROCESSOR} MATCHES "i386"
	  ...
	  set(SYSTEM_IS_X86 FALSE CACHE INTERNAL "Is not x86")
	endif()
	...
	message(STATUS "CMAKE_SYSTEM_PROCESSOR is empty, asuming SYSTEM_IS_X86")
	set(SYSTEM_IS_X86 TRUE  CACHE INTERNAL "Is x86")
	set(SYSTEM_IS_PPC FALSE CACHE INTERNAL "Is PPC")
endif()
