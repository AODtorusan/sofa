// This file is automatically generated by ./genHeader.sh.
//
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauApco13(double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, iauASTROM *astrom, double *eo);
/**
 *  - - - - - - - -
 *   i a u A p c s
 *  - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauApio13(double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, iauASTROM *astrom);
/**
 *  - - - - - - - - - -
 *   i a u A t c i 1 3
 *  - - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauAtco13(double rc, double dc, double pr, double pd, double px, double rv, double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, double *aob, double *zob, double *hob, double *dob, double *rob, double *eo);
/**
 *  - - - - - - - - - -
 *   i a u A t i c 1 3
 *  - - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport void iauAticqn(double ri, double di, iauASTROM *astrom, int n, iauLDBODY b[], double *rc, double *dc);
/**
 *  - - - - - - - - - -
 *   i a u A t i o 1 3
 *  - - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauAtio13(double ri, double di, double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, double *aob, double *zob, double *hob, double *dob, double *rob);
/**
 *  - - - - - - - - -
 *   i a u A t i o q
 *  - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauAtoc13(const char *type, double ob1, double ob2, double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, double *rc, double *dc);
/**
 *  - - - - - - - - - -
 *   i a u A t o i 1 3
 *  - - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport int iauAtoi13(const char *type, double ob1, double ob2, double utc1, double utc2, double dut1, double elong, double phi, double hm, double xp, double yp, double phpa, double tc, double rh, double wl, double *ri, double *di);
/**
 *  - - - - - - - - -
 *   i a u A t o i q
 *  - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport void iauPmpx(double rc, double dc, double pr, double pd, double px, double rv, double pmt, double pob[3], double pco[3]);
/**
 *  - - - - - - - - - -
 *   i a u P m s a f e
 *  - - - - - - - - - -
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport void iauRefco(double phpa, double tc, double rh, double wl, double *refa, double *refb);
 ...
 *  Copyright (C) 2013 IAU SOFA Board.  See notes at end.
*/
SOFAExport void iauPrec76(double date01, double date02, double date11, double date12, double *zeta, double *z, double *theta);
/**
 *  - - - - - - -
 *   i a u S 0 0
 *  - - - - - - -
